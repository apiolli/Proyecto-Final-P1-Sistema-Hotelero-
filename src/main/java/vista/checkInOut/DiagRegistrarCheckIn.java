...
public class DiagRegistrarCheckIn extends javax.swing.JDialog {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DiagRegistrarCheckIn.class.getName());
    
    private ControladorReserva controlador;
    
    public DiagRegistrarCheckIn(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Registrar CheckIn");
