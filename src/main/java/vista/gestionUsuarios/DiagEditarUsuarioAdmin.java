...
public class DiagEditarUsuarioAdmin extends javax.swing.JDialog implements Mensajes {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(DiagEditarUsuarioAdmin.class.getName());
    
    private ControladorEmpleadoAdmin controlador;

   
    public DiagEditarUsuarioAdmin(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Edición de usuarios y administradores");
    ...
    private void btnDIagActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDIagActionPerformed
       btnDIag.setEnabled(false);
        ...
        if (txtNombre.getText().trim().isEmpty() || 
            ...
            mostrarError("Por favor, no deje ningún campo vacío al editar.");
  ...
  @Override
    ...
    public void setCargo(String cargo) { txtCargo.setText(cargo); }
    public void setUsuario(String usuario) { txtUsuario.setText(usuario); }
    public void setContrasena(String contrasena) { txtContrasena.setText(contrasena); }
    public void setNivelAcceso(String nivel) { nivelAcc.setSelectedItem(nivel); }
