...
public class PanelFacturacion extends javax.swing.JPanel {
    ...
    private void panelDelMedio() {
        ...
        wrapper.setBackground(panelMedio.getBackground()); // hereda el color del panel padre

        GridBagConstraints gbc = new GridBagConstraints();
        gbc.fill = GridBagConstraints.BOTH; // la tabla se expande en ambas direcciones
        gbc.weightx = 1.0;                 // ocupa todo el ancho disponible
        gbc.weighty = 1.0;                 // ocupa todo el alto disponible
        gbc.insets = new Insets(20, 40, 20, 40); // margen: top, left, bottom, right
